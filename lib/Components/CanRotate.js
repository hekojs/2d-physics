...
var _default = /*#__PURE__*/function (_Heko$Component) {
  ...
  _createClass(_default, [{
    key: "toAngle",
    value: function toAngle(_ref) {
      var _this2 = this;

      var angle = _ref.angle;
      this.entity.world.gsap.killTweensOf(this.animation, 'angle');
      this.entity.world.gsap.fromTo(this.animation, {
        angle: _core["default"].Angle.toDeegree(this.entity.components.physics.body.angle)
      }, {
        angle: angle,
        duration: this.inertia,
        onUpdate: function onUpdate() {
          _matterJs["default"].Body.setAngle(_this2.entity.components.physics.body, _core["default"].Angle.toRadian(_this2.animation.angle));
        }
      });
    }
  }, {
    key: "toPoint",
    value: function toPoint(_ref2) {
      var x = _ref2.x,
          y = _ref2.y;
      this.toAngle({
        angle: _core["default"].Angle.fromPointToPoint(this.entity.hasPosition.x, this.entity.hasPosition.y, x, y)
      });
    }
  }]);
